    ...
    >
      ...
      <div class="JK-dialog-footer-container">
        <div class="top-container">
          <div class="left-button-container" @click="clickChangePhone()">
            {{ leftButtonText }}
          </div>
          <div class="right-button-container" @click="confirm()">
            {{ rightButtonText }}
          </div>
        </div>

        <div class="bottom-container" @click="changeIsDialogShowState(false)">
          取消充值
        </div>
      </div>
    </div>
...
export default {
  ...
  methods: {
    ...
    clickChangePhone() {
      this.changeIsDialogShowState(false);
      this.$emit('changePhoneFromFather');
    },

    confirm() {
      this.changeIsDialogShowState(false);
      this.$emit('confirmFromFather');
    },
  },
};
</script>
