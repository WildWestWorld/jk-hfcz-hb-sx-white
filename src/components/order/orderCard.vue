    ...
    <div class="order-card-wrapper">
      <div class="top-order-num-container">
        <div class="top-order-num-wrapper">
          <div class="order-num">订单编号:{{ item.OrSn }}</div>
          <div class="order-status">{{ orderStateEmun[item.OrState] }}</div>
        </div>
      </div>
      <div class="bottom-info-container">
        <div class="bottom-info-wrapper">
          ...
          <div class="order-info-container">
            <div class="title-container">{{ item.CardName }}</div>
            ...
            <div
              class="compelete-time-container"
